...
var key = fs.readFileSync("/home/sslforlocalmarket/taplocal.key");
var cert = fs.readFileSync("/home/sslforlocalmarket/cert.crt");
var ca = fs.readFileSync("/home/sslforlocalmarket/chain.crt");
var options = {
  pingTimeout: 1000,
  pingInterval: 5000
};
...
var server = require("https").createServer(options_https, app);
var io = require("../..")(server, options);
var axios = require("axios");
var port = process.env.PORT || 7000;
const API_BASE_URL = "https://dashboard.taplocalmarketing.com:5000/beta/";
server.listen(port, () => {
...
io.sockets.on('connection', function (socket) {
      ...
      .then(function (response) {
        ...
        if (obj.is_pin == true && obj.device_type == "customer") {
          if (obj && response.data.data.status == true && response.data.data.client_ip == client_ip_address) {
            ...
            console.log("Please provide us valid pin");
  ...
  */
  ...
  socket.on('disconnecting', function () {
    console.log("disconnecting from staging....", socket.username);
    delete usernames[socket.username];
    socket.to(socket.room).emit("Please wait connection is not closed properly.");
    socket.leave(socket.room);
  });
  ...
  */
  ...
  //     host: "taprds-1.cluster-cokeytqlmxxk.us-west-2.rds.amazonaws.com",
  //     user: "root",
